...
namespace Carrot
{
    public interface IChannel
    {
        ...
        void SubscribeByAtMostOnce(Queue queue, Action<SubscriptionConfiguration> configure);

        void SubscribeByAtLeastOnce(Queue queue, Action<SubscriptionConfiguration> configure);
    }
}